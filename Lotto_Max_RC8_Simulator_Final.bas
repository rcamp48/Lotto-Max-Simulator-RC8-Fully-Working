...
REM *** Lotto Max Simulator Version 2020 RC8 Working Version With Automatic Draw Date Update
REM *** Fully 99.999 % working copy Most up to date.
REM *** Written by: Russ Campbell
REM
REM *** Last Update : January 15 2020 6:00 PM
REM
...
LOCATE 6, 9
PRINT " Lotto Max 2020 RC8 Version Lotto Max Simulator Game  Vers   "
LOCATE 7, 9
...
CLS
PRINT
PRINT "Welcome to the Lotto Max 2020 Simulator. This program"
...
newbalance = oldbalanace - moneytotal
INPUT #1, oldbalance
PRINT
CLOSE #1
...
oldbalance = startbalance - oldbalance
newbalance = oldbalance + winningstotal - moneytotal
OPEN "totalbalance.dat" FOR OUTPUT AS #1
OPEN "oldbalance.dat" FOR INPUT AS #2
INPUT #2, oldbalance
CLOSE #2
PRINT #1, newbalance
PRINT #1, oldbalance
PRINT #1, moneytotal
PRINT #1, winningstotal
...
PRINT
PRINT "|--------------------------------------------------------------------------|"
PRINT "| Previous Balance| Tickets Cost    |    Winnings       |  New Balance     |"
PRINT "|-----------------|-----------------|-------------------|------------------|"
pt$ = "|$ #,###,###,###  | $ #,###,###,### |   $ #,###,###,### |  $ #,###,###,### |"
PRINT USING pt$; newbalance; moneytotal; winningstotal; newbalance - moneytotal
...
PRINT
IF money < winningstotal THEN
    PRINT "You have Lost : "; moneytotal - winningstotal
    PRINT "But you have "
END IF
IF winningstotal > moneytotal THEN
    PRINT "Including free tickets"
    PRINT "You have gained an extra $ "; winningstotal - money
END IF
PRINT
PRINT "Press any key to continue..."
DO WHILE INKEY$ = ""
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 5, 8
PRINT "        Lotto Max Simulator RC8 Version 2020  Main Menu           "
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 3, 7
PRINT "     Lotto Max Simulator RC8 Version 2020 Barchart Menu            "
LOCATE 13, 7
...
FOR i = 1 TO 50
    ...
    IF crs$ = "Y" THEN COLOR 10, 5
    LOCATE 4, 11
    PRINT "Lotto Max Simulator RC8 Version 2020   Search & Print Menu"
    IF crs$ = "Y" THEN COLOR 4, 7
    FOR i = 6 TO 10
        LOCATE i, 17
        PRINT "["
...
grandtotalcash = cash3total + cash3btotal + cash4total + cash4btotal + cash5total + cash5btotal + cash6total + cash6btotal + cash7total
...
CLS
PRINT
PRINT "Lotto Max Package Version 2020 RC8 Winning Numbers Entry"
PRINT "--------------------------------------------------------"
PRINT
...
LOCATE 4, 18
PRINT " Lotto Max Version 2020 RC8  Print Menu  "
IF crs$ = "Y" THEN COLOR 3, 8
LOCATE 3, 17
PRINT CHR$(201)
FOR i = 18 TO 57
...
CLS
PRINT
PRINT "Lotto Max 2020 RC8 Simulation Program With Real Time Game Play Rules."
PRINT "---------------------------------------------------------------------"
PRINT
...
CLS
PRINT
PRINT "Basic Rules and object of this Lotto Max 2020 RC8 Lottery Simulator"
PRINT "-------------------------------------------------------------------"
PRINT
...
serial$ = reg2$
version$ = "2020 RC8D"
release$ = "January 15 2020 - 10:00 PM"
...
PRINT
PRINT
PRINT "About This Lotto Max RC8 Simulator and all of the other"
...
PRINT "(6) Welcome to the Lotto Max 2020 RC8 Simulator'"
...
PRINT "before the next draw. All wiinners must match their pretend"
...
PRINT "come crying to me or anyone else its only a game, not rral."
PRINT "(I just hope you don't wi the big one without an actual"
